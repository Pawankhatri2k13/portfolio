...
cur_1.execute('''DROP TABLE IF EXISTS DNSMapping ''')

cur_1.execute('''CREATE TABLE IF NOT EXISTS DNSMapping
    (old TEXT, new TEXT)''')
...
cur_1.execute('''DROP TABLE IF EXISTS Mapping''')

cur_1.execute('''CREATE TABLE IF NOT EXISTS Mapping
    (old TEXT, new TEXT)''')
